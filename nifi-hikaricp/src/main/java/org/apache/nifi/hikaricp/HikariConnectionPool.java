...
public class HikariConnectionPool extends AbstractControllerService implements HikariCPService {
...
//        config.addDataSourceProperty("prepStmtCacheSqlLimit", "2048");
    ...
    public String toString() {
        return "HikariConnectionPool[id=" + getIdentifier() + "]";
    }
}
